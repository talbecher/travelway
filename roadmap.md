...
- [ ] checkPilotAccess + הסתרת Discover ממשתמשים לא מורשים בשני המסכים
- [ ] מצבי כרטיס „נשמר ✓” / „ביום זה ✓” וניתנות לבחירה לפי הקשר
- [ ] פעולה משולבת „שמרו והוסיפו ליום” עם טיפול פר־מקום וכשל חלקי
- [ ] שבבי פילטר מקומיים (תחומים, הסתר שמורים, הסתר ביום) + ספירת מוסתרים
- [ ] שורת סיכום דביקה המחליפה את כפתור השמירה
- [ ] bun run build ו־bunx tsgo --noEmit
