...
# עיצוב טופס „הוצאה מהירה”

- [x] לעצב מחדש את QuickExpenseForm הקיים בלבד כמראה קבלה רספונסיבי
- [x] לשמר את כל לוגיקת המטבע, ההמרה, השמירה והאירוע הקיימת
- [x] להריץ TypeScript ו־build; בדיקות 360px ו־390px נחסמו כי לחשבון הבדיקה אין טיול פעיל
