...
- [ ] כותרת נקייה על רקע חם (הסרת תמונת רקע — תצוגתית בלבד), מספר יום בולט + תאריך, כפתורים ≥44px
- [ ] כרטיסי תחנות לבנים, גבול חם עדין, רדיוס 16, בלי צל כבד
- [ ] ציר זמן coral מימין עם מספרים אמיתיים, אין קו אחרי התחנה האחרונה, pointer-events מושתקים
- [ ] גשר „אפשרויות הגעה" coral בהיר, min-height 56, גמיש, מתחבר לציר
- [ ] סרגל הוספה תחתון: + ≥48px, safe-area נשמר; יום ריק בשפת A2
- [ ] בלי שינוי handlers/queries/mutations/routes/drag/map/Discover/BottomNav; רק tsgo + build
