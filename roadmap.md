...
- [ ] לעצב מחדש את QuickExpenseForm הקיים בלבד כמראה קבלה רספונסיבי
- [ ] לשמר את כל לוגיקת המטבע, ההמרה, השמירה והאירוע הקיימת
- [ ] להריץ TypeScript, build ובדיקות דפדפן ב־360px וב־390px
